...
const ProductCard = () => {
    return (
        <div className='group bg-white border-transparent border border-white hover:border-gray-800 rounded-[3px] p-4 shadow-sm h-full'>
            <div className='relative overflow-hidden'>
                ...
                <button className='p-1 rounded-full hover:bg-gray-200 absolute top-2 -right-10 transition duration-300 ease-in-out transform delay-150 group-hover:-translate-x-10'><span className='text-gray-500 text-xl'><AiOutlineEye/></span></button>
                <button className='p-1 rounded-full hover:bg-gray-200 absolute top-10 -right-10 transition duration-500 ease-in-out transform delay-150 group-hover:-translate-x-10'><span className='text-gray-500 text-xl'><AiOutlineHeart/></span></button>
            </div>
