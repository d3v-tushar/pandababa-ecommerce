    ...
    return (
        <div className='group bg-white border-transparent border border-white hover:border-gray-800 rounded-[3px] shadow-sm h-full'>
            <div className='relative overflow-hidden'>
                ...
                <button className='p-1 rounded-full hover:bg-gray-200 absolute top-4 -right-10 transition duration-300 ease-in-out transform delay-150 group-hover:-translate-x-12'><span className='text-gray-500 text-xl'><AiOutlineEye/></span></button>
